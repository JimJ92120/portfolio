...
export default {
  ...
  gallery: new Frame(
    ...
    {
      ["3,2"]: [FrameActionType.Prompt, "games"],
      ["6,2"]: [FrameActionType.Prompt, "project-4"],
      ["2,3"]: [FrameActionType.Prompt, "wordpress"],
      ["7,3"]: [FrameActionType.Prompt, "official-production"],
      ["2,5"]: [FrameActionType.Prompt, "nixos"],
      ["7,5"]: [FrameActionType.Prompt, "hoopers-heaven"],
      ["4,8"]: [FrameActionType.Load, "main"],
      ["5,8"]: [FrameActionType.Load, "main"],
    },
    [4, 7],
